  ...
  Widget build(BuildContext context) {
    ...
    void _onItemReorder(int oldItemIndex, int oldListIndex, int newItemIndex, int newListIndex) async {
      try {
        ...
        // ❗ 리스트가 비어 있는지 먼저 체크 후 갱신
        // controller.todoListGroup.removeWhere((group) => group.todoList.isEmpty);
      ...
      child: Obx(() {
        controller.contents.value = List.generate(controller.todoListGroup.length, (index) {
          return DragAndDropList(
            ...
            header: Container(
              height: 50,
              child: Obx(() => controller.todoListGroup.isEmpty ? Container()
                  : SlidablePanel(
            ...
            children: [
                ...
                // TODO : 아래 주석만 해제 하면 됨. - 1번
                  if(controller.todoListGroup[index].todoList.isNotEmpty)
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: SingleChildScrollView(
                                                child: Text(
                                                  controller.todoListGroup[index].todoList.isEmpty ? '' : controller.todoListGroup[index].todoList[i].content,
                                                  style: TextStyle(
                                                    fontSize: 16,
                                                    color: subColor,
        ...
        return Obx(() => SizedBox(
            ...
            child: controller.isDetail.value ? TodoListGroupDetailView()
                : DragAndDropLists(
              itemGhost: const SizedBox(height: 50,),
              onListDraggingChanged: (isDragging, bool) {
                ...
                itemDragHandle: !controller.isGroupEdit.value ? DragHandle(child: Icon(Icons.drag_handle, size: 20, color: Color(0xffD9D9D9),)) : null,
